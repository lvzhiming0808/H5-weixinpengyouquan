...
if (strpos($user_agent, 'MicroMessenger') === false){
    ...
    if(!isset($_GET['code'])){
		$url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxadfd8159e6da1d4f&redirect_uri=http://h5.sc.ministudy.com/index.php&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect";
...
wx.ready(function(){
   wx.onMenuShareTimeline({
    title: '这3道小学历史题居然难倒了这么多人？！', // 分享标题 分享到朋友圈
    link: 'http://h5.sc.ministudy.com', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
    imgUrl: 'http://h5.sc.ministudy.com/sharricon.jpg', // 分享图标
    success: function () { 
        // 用户确认分享后执行的回调函数
    },
    cancel: function () { 
...
wx.onMenuShareQQ({
    title: '这3道小学历史题居然难倒了这么多人？！', // 分享标题
    desc: '', // 分享描述
    link: 'http://h5.sc.ministudy.com', // 分享链接
    imgUrl: 'http://h5.sc.ministudy.com/sharricon.jpg', // 分享图标
    success: function () { 
       // 用户确认分享后执行的回调函数
    },
...
<div class="twobg page page5">
    ...
    <div class="cont">
       ...
       <div class="wo2zonghe" style="display: none;">
        	<img src="img/wo2.png" class="user wo2">
        	<img src="<?php echo $headimgurl;?>" class="petitle wodisply wo2-1">
        </div>
        <div class="wo3zonghe" style="display: none;">
        	<img src="img/wo3.png" class="user wo3">
        	<img src="<?php echo $headimgurl;?>" class="petitle wodisply wo3-1">
        </div>
        <div class="wo4zonghe" style="display: none;">
        	<img src="img/wo4.png" class="user wo4">
        	<img src="<?php echo $headimgurl;?>" class="petitle wodisply wo4-1">
        </div>
            <div><img src="img/wangwei.png" class="user user-left wangwei animated fadeInUp"></div>
        <div class="wo5zonghe" style="display: none;">
        	<img src="img/wo5.png" class="user wo5">
        	<img src="<?php echo $headimgurl;?>" class="petitle wodisply wo5-1">
        </div>
    ...
    <div style="display: none" class="friends">
        <div class="part_1 clearfix">
            <div class="header_user clearfix fr">
                <h1 class="fl"><?php echo $nickname;?></h1>
